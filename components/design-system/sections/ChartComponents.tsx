...
import { Bar, BarChart, CartesianGrid, XAxis, Line, LineChart, Pie, PieChart, Label } from "recharts"
    ...
    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Multiple Data Points</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Curved Lines</CardDescription>
        </CardHeader>
        <CardContent>
